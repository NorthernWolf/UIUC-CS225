...
class Shape : public Drawable
{
	...
	public:
		...
		virtual ~Shape() { /* Nothing */ } //needed to make this virtual! shape is an abstract class
		 ...
		 */
		virtual int area() const; //needed to make this virtual! shape is an abstract class
		 ...
		 */
		virtual int perimeter() const; //needed to make this virtual! shape is an abstract class
